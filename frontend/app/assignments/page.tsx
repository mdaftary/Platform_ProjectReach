  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Assignment Hub</p>
                </div>
              </Link>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-foreground mb-2">Assignment Hub</h2>
          <p className="text-muted-foreground">View assignments, submit work, and track your child's progress</p>
        </div>
